        ...
        <div className="prose prose-sm sm:prose-base max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-base sm:text-lg">2.2. Постановка на миграционный учет (для иностранных граждан)</h3>
                <p className="text-muted-foreground leading-relaxed mb-3">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-base sm:text-lg">2.3. Процедура заселения</h3>
              ...
              <div>
                <h3 className="font-semibold mb-2 text-base sm:text-lg">2.4. Процедура выселения</h3>
                <ol className="list-decimal list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Для курения предусмотрена специальная зона на улице. <strong>Штраф за курение в номере — 30 000 рублей и немедленное выселение без возврата оплаты.</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    <strong>Проживание с домашними животными запрещено.</strong>
                  </p>
                </div>
              </div>
