            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  иностранные граждане обязаны встать на миграционный учет по месту пребывания в следующие сроки:
                </p>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-3">
                  <li>Подать уведомление о прибытии иностранного гражданина в орган МВД России в установленные законом сроки</li>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Без миграционной карты постановка на учет невозможна.
                </p>
              </div>
