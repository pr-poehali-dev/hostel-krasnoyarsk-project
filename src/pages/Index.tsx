            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 pt-8">
              ...
              <Card className="border-2 hover:border-primary transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-center leading-tight px-2 flex flex-col items-center">
                    <span>Удобное</span>
                    <span className="text-xl">расположение</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      г. Красноярск, улица 2-я Красногорская, дом 3
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
